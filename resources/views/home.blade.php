...
<section class="container my-5">
    ...
    <div class="product-slider">
        <div class="swiper ps2Swiper">
            <div class="swiper-wrapper">
                @foreach($ps2Products as $product)
                <div class="swiper-slide">
                    <div class="card product-card position-relative">
                        @if($product->sale_price)
                            <span class="badge-sale">SALE</span>
...
<section class="container my-5">
    ...
    <div class="product-slider">
        <div class="swiper ps3Swiper">
            <div class="swiper-wrapper">
                @foreach($ps3Products as $product)
                <div class="swiper-slide">
                    <div class="card product-card position-relative">
                        @if($product->sale_price)
                            <span class="badge-sale">SALE</span>
...
<!-- Nintendo GameCube Products -->
@if($gamecubeProducts->count() > 0)
<section class="container my-5">
    <h2 class="section-title">
        <img src="{{ asset('images/icons/gamecube.svg') }}" alt="GameCube" style="width: 40px; height: 40px; margin-right: 0.5rem; vertical-align: middle;"> Nintendo GameCube
    </h2>
    <div class="product-slider">
        <div class="swiper gamecubeSwiper">
            <div class="swiper-wrapper">
                @foreach($gamecubeProducts as $product)
                <div class="swiper-slide">
                    <div class="card product-card position-relative">
                        @if($product->sale_price)
                            <span class="badge-sale">SALE</span>
...
@if($wiiProducts->count() > 0)
<section class="container my-5">
    <h2 class="section-title">
        <img src="{{ asset('images/icons/wii.svg') }}" alt="Nintendo Wii" style="width: 40px; height: 40px; margin-right: 0.5rem; vertical-align: middle;"> Nintendo Wii
    </h2>
    <div class="product-slider">
        <div class="swiper wiiSwiper">
            <div class="swiper-wrapper">
                @foreach($wiiProducts as $product)
                <div class="swiper-slide">
                    <div class="card product-card position-relative">
                        @if($product->sale_price)
                            <span class="badge-sale">SALE</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // PS2 Products Slider
    const ps2Swiper = new Swiper('.ps2Swiper', {
        slidesPerView: 1,
        spaceBetween: 20,
        loop: true,
        autoplay: {
        ...
        navigation: {
            nextEl: '.ps2Swiper .swiper-button-next',
            prevEl: '.ps2Swiper .swiper-button-prev',
        },
        pagination: {
            el: '.ps2Swiper .swiper-pagination',
            clickable: true,
            dynamicBullets: true,
        },
        breakpoints: {
    ...
    // PS3 Products Slider
    const ps3Swiper = new Swiper('.ps3Swiper', {
        slidesPerView: 1,
        spaceBetween: 20,
        loop: true,
        autoplay: {
        ...
        navigation: {
            nextEl: '.ps3Swiper .swiper-button-next',
            prevEl: '.ps3Swiper .swiper-button-prev',
        },
        pagination: {
            el: '.ps3Swiper .swiper-pagination',
            clickable: true,
            dynamicBullets: true,
        },
        breakpoints: {
    ...
    // Nintendo GameCube Products Slider
    const gamecubeSwiper = new Swiper('.gamecubeSwiper', {
        slidesPerView: 1,
        spaceBetween: 20,
        loop: true,
        autoplay: {
        ...
        navigation: {
            nextEl: '.gamecubeSwiper .swiper-button-next',
            prevEl: '.gamecubeSwiper .swiper-button-prev',
        },
        pagination: {
            el: '.gamecubeSwiper .swiper-pagination',
            clickable: true,
            dynamicBullets: true,
        },
        breakpoints: {
    ...
    const wiiSwiper = new Swiper('.wiiSwiper', {
        slidesPerView: 1,
        spaceBetween: 20,
        loop: true,
        autoplay: {
        ...
        navigation: {
            nextEl: '.wiiSwiper .swiper-button-next',
            prevEl: '.wiiSwiper .swiper-button-prev',
        },
        pagination: {
