            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input category-quick-select" id="cat_wii" name="category_quick" value="wii" data-category-name="Nintendo Wii" {{ $currentCategorySlug == 'wii' || $currentCategorySlug == 'nintendo-wii' ? 'checked' : '' }}>
